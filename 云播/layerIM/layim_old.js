...
layui.define(['jquery', 'layer', 'laytpl', 'upload'], function(exports){
  ...
  var layimChat, layimMin, chatIndex, To = {}, popchat = function(data){
    ...
    var index = chatIndex = layer.open({
      ...
      ,cancel :function(){
        $('.tan-gift').removeClass('pos').appendTo($('body')).hide();
      }
      ,min: function(){
        setChatMin();
        return false;
